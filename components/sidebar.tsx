...
export function Sidebar({ user, userRole, isSuperAdmin = false, podeGerir = false }: SidebarProps) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-0 w-64 hidden md:flex md:pointer-events-auto flex-col overflow-y-auto shadow-xl pointer-events-none md:pointer-events-auto" style={{ background: 'linear-gradient(180deg, #0a1628 0%, #0f172a 50%, #1a2847 100%)', borderRight: '2px solid #0066cc' }}>
      {/* Logo */}
