...
export function Sidebar({ user, userRole, isSuperAdmin = false, podeGerir = false }: SidebarProps) {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-10 w-64 hidden lg:flex flex-col overflow-y-auto shadow-xl" style={{ background: 'linear-gradient(180deg, #0a1628 0%, #0f172a 50%, #1a2847 100%)', borderRight: '2px solid #0066cc', marginTop: '4rem' }}>
      {/* Logo */}
