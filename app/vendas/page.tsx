        ...
        <main className="flex-1 md:ml-64 pt-16" style={{ minHeight: '100vh' }}>
          <div className="p-4 md:p-8">
            ...
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold" style={{ color: '#1e293b' }}>As Minhas Vendas</h1>
              ...
              <Link href="/vendas/novo">
                <button className="flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-90" style={{ background: 'linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%)' }}>
            ...
            <div className="flex flex-col md:flex-row gap-3 mb-6">
              ...
              <select value={filter} onChange={e => setFilter(e.target.value)}
                ...
                style={{ background: '#fff', border: '1px solid #e2e8f0', color: '#1e293b', minWidth: 180 }}>
