  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc' }}>
      ...
      <div className="flex">
        ...
        <main className="flex-1 lg:relative lg:z-10 overflow-auto pt-20 md:pt-20 lg:ml-64 w-full">
          <div className="p-4 md:p-5 max-w-5xl mx-auto w-full mx-auto w-full">
              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
                <div className="rounded-2xl p-6 w-full max-w-md shadow-xl" >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea value={newCargo.descricao} onChange={e => setNewCargo({ ...newCargo, descricao: e.target.value })}
                        className="w-full rounded-lg px-3 py-2.5 text-sm" rows={2}  />
                    </div>
                  </div>
                  <div className="flex justify-end gap-3 mt-6">
                    ...
                    <button onClick={addCargo} className="px-4 py-2 rounded-lg text-sm font-semibold text-white" >Guardar</button>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="space-y-4">
              {cargos.map(cargo => {
                ...
                return (
                  <div key={cargo.id} className="rounded-2xl shadow-sm overflow-hidden" >
                    {/* Header do Cargo */}
                    <div className="p-4 flex items-center justify-between" >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {isEditing ? (
                          <>
                            <button onClick={() => saveCargo(editingCargo)} className="p-1.5 rounded-lg" ><Save size={16} style={{ color: '#22c55e' }} /></button>
                            <button onClick={() => setEditingCargo(null)} className="p-1.5 rounded-lg" ><X size={16} style={{ color: '#ef4444' }} /></button>
                          </>
                        ) : (
                          <>
                          ...
                          <div key={u.id} className="p-4 flex items-center justify-between hover:bg-slate-50">
                            ...
                            {editingUser === u.id ? (
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <button onClick={() => saveUserHierarchy(u.id)} className="p-1.5 rounded-lg" ><Save size={16} style={{ color: '#22c55e' }} /></button>
                                <button onClick={() => { setEditingUser(null); setUserChanges({}) }} className="p-1.5 rounded-lg" ><X size={16} style={{ color: '#ef4444' }} /></button>
                              </div>
                            ) : (
                              <div className="flex items-center gap-3">
                                {u.responsavel_id && (
