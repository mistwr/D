      ...
      <div className="hidden lg:flex lg:w-1/2 bg-foreground text-white flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-brand rounded-lg flex items-center justify-center"><span className="text-white font-bold text-sm">P</span></div>
            <span className="font-bold text-xl text-white tracking-tight">PARCEN<span className="text-blue-400">Di</span></span>
          </Link>
        </div>
        <div className="relative">
          <h2 className="text-3xl font-bold mb-4 text-balance">O seu CRM multisserviços tudo-em-um</h2>
          <p className="text-slate-300 leading-relaxed">Gerencie leads, negócios, comissões, tarefas e documentos numa plataforma unificada e escalável para toda a equipa PARCENDi.</p>
        ...
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-8 text-center">
            <Link href="/" className="inline-flex items-center gap-2">
              <div className="w-8 h-8 bg-brand rounded-lg flex items-center justify-center"><span className="text-white font-bold text-sm">P</span></div>
              <span className="font-bold text-xl tracking-tight">PARCEN<span className="text-brand">Di</span></span>
            </Link>
          </div>
          ...
          <LoginForm />
          <p className="text-center text-sm text-muted-foreground mt-6">As contas de acesso são criadas pelo administrador PARCENDi.</p>
        </div>
      </div>
    </div>
  )
